 ...
 *
 * Defaults to gpt-5.5-pro — the current pro-tier release (2026-04-22),
 ...
 *
 * Override per environment with the FINBOT_MODEL env var (e.g. set
 * FINBOT_MODEL=gpt-5.5 to drop to the standard tier for cost). Same model
 * is used for the FinBot chat and BOTH sides of the Side-by-side comparison
 * so the comparison stays fair (raw vs raw + axiom tools).
 */
import { openai } from "@ai-sdk/openai";

export const FINBOT_MODEL_NAME = process.env.FINBOT_MODEL ?? "gpt-5.5-pro";
