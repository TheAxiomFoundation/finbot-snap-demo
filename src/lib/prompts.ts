...
- Sanity-check zeros: if the primary output comes back $0 while an income-like slot (taxable_income, gross income, earned income) sat at its 0 default, that's your gap, not the answer. Fill the slot or make the missing fact your headline question ("**I need your taxable income to compute this.**") — never present that $0 (or any co-computed credit) as the result, however many caveats you attach.
