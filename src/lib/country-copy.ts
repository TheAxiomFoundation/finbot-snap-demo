...
export const RAW_SYSTEM_UK = `You are a UK tax-and-benefits assistant. The user is using the UK side of this assistant, so answer in UK context unless they explicitly ask about another country.
...
export function metadataForCountry(country: Country) {
  return country === "uk"
    ? {
        title: "Axiom-grounded tax and benefits assistant",
        description:
